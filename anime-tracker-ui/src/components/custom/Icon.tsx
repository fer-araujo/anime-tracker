...
const paths: Record<IconName, { viewBox: string; children: ReactElement[] }> = {
  ...
  AlertCircle: {
    ...
    children: [
      <path
        key="alert"
        d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-1-1 2-4-2-4 1-1 3 5-2 4 1 1h-2zm2-5h-1v-2h2v2zm0 4h-1v-2h2v2z"
        fill="currentColor"
      />,
    ],
  },
  ...
  Trash2: {
    ...
    children: [
      <path
        key="trash"
        d="M3 6v2h18V6H3zm3 12c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V8H6v10zm3-8h2v8H9v-8zm4 0h2v8h-2v-8zM13 3h-4l-1 2H4v2h18V5h-4l-1-2z"
        fill="currentColor"
      />,
    ],
  },
  ...
  Share2: {
    ...
    children: [
      <path
        key="share2"
        d="M18 16.08c-.76 0-1.44.3-1.96.77L8.91 12.7c.05-.23.09-.46.09-.7s-.04-.47-.09-.7l7.05-4.11c.54.5 1.25.81 2.04.81 1.66 0 3-1.34 3-3s-1.34-3-3-3-3 1.34-3 3c0 .24.04.47.09.7L8.04 9.81C7.5 9.31 6.79 9 6 9c-1.66 0-3 1.34-3 3s1.34 3 3 3c.79 0 1.5-.31 2.04-.81l7.12 4.16c-.05.24-.09.46-.09.69 0 1.66 1.34 3 3 3s3-1.34 3-3-1.34-3-3-3z"
        fill="currentColor"
      />,
    ],
  },
  ...
  MonitorPlay: {
    ...
    children: [
      <path
        key="monitor-play"
        d="M22 3H2c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h7v2H8v2h8v-2h-1v-2h7c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 14H2V5h20v12zM9.5 8.5v5l5-3-5-2z"
        fill="currentColor"
      />,
    ],
  },
