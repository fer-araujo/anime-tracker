...
const icons: Record<string, React.ReactNode> = {
  ...
  Netflix: (
    <svg viewBox="0 0 24 24" aria-hidden="true" className="h-[14px] w-[14px]">
      ...
      <path
        d="M7 4h3l3.5 16H10.5L7 4Zm4 0h3l3.5 16H14.5L11 4Z"
  ...
  "Amazon Prime Video": (
    <svg viewBox="0 0 24 24" aria-hidden className="h-[14px] w-[14px]">
      <path
        d="M20.5 15c-3 2.5-8.5 4-12 3.5 3 .5 8.5-1 12-3.5Zm-7-7.5c.9-1.2 2.6-1 3.3.3.6 1.2.1 2.8-1 3.4l-1.1.6v1.2h-1.6V8.4l1.5-.9c.5-.3.7-.9.4-1.4-.3-.6-1-.7-1.5-.3l-.8.6-.9-1.1.7-.4Z"
        className="fill-current"
      />
    </svg>
  ),
  Crunchyroll: (
    <svg viewBox="0 0 24 24" aria-hidden className="h-[14px] w-[14px]">
      <path
        d="M12 3a9 9 0 1 0 7.9 13.2 7 7 0 1 1-8.7-10.8A8.9 8.9 0 0 1 12 3Z"
        className="fill-current"
      />
    </svg>
  ),
  "Disney+": (
    <svg viewBox="0 0 24 24" aria-hidden className="h-[14px] w-[14px]">
      <path
        d="M3 15a9 9 0 0 1 18 0h-2a7 7 0 0 0-14 0H3Z"
        className="fill-current"
      />
    </svg>
  ),
  ...
  Max: (
    <svg viewBox="0 0 24 24" aria-hidden className="h-[14px] w-[14px]">
      <path
        d="M5 16V8h2l2 3 2-3h2v8h-2v-5l-2 3-2-3v5H5Z"
        className="fill-current"
      />
    </svg>
  ),
